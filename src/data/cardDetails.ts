...
export const PUBLIC_CARD_DETAILS: Record<string, DetailedCardInfo> = {
  ...
  'Jack Ma': {
    name: 'Jack Ma',
    category: 'Öffentlichkeit',
    gameEffect: 'Beim Ausspielen: Ziehe 1 Karte.',
    deckCost: 7,
    subcategories: ['Oligarch', 'Tech', 'Plattform'],
    nationality: 'Chinesisch',
  ...
  'Warren Buffett': {
    name: 'Warren Buffett',
    category: 'Öffentlichkeit',
    gameEffect: 'Aura: Zu Beginn deines Zuges +1 Einfluss auf deine stärkste Regierungskarte, wenn du im vorherigen Zug keine Regierungskarte gespielt hast.',
    deckCost: 7,
  ...
  'Jeff Bezos': {
    name: 'Jeff Bezos',
    category: 'Öffentlichkeit',
    gameEffect: 'Beim Ausspielen: Entfernt alle Oligarchenkarten des Gegners vom Spielfeld.',
    deckCost: 6,
    subcategories: ['Oligarch'],
    nationality: 'US-Amerikanisch',
  ...
  'Gautam Adani': {
    name: 'Gautam Adani',
    category: 'Öffentlichkeit',
    gameEffect: 'Oligarch – zählt für Oligarchen-Synergien (kein Corruption-Probe-Bonus).',
    deckCost: 6,
    subcategories: ['Oligarch'],
    nationality: 'Indisch',
...
export const SPECIAL_CARD_DETAILS: Record<string, DetailedCardInfo> = {
  ...
  'Digitaler Wahlkampf': {
    ...
    category: 'Sofort-Initiative',
    gameEffect: 'Ziehe 1 Karte pro eigener Medien-/Plattform-Karte auf dem Feld (maximal 2).',
    deckCost: 3,
    subcategories: ['Groß'],
    cardType: 'Sofort-Initiative',
    tier: 'T3',
    usage: 'Für Kartenfluss in Medien-/Plattform-Decks',
    example: '3 Medien auf dem Feld → ziehe 2 (Cap)',
  },

  'Partei-Offensive': {
    name: 'Partei-Offensive',
    category: 'Sofort-Initiative',
    gameEffect: 'Die stärkste gegnerische Regierungskarte erhält −3 Einfluss.',
    deckCost: 3,
    subcategories: ['Groß'],
    cardType: 'Sofort-Initiative',
    tier: 'T3',
    usage: 'Gegen starke gegnerische Regierungskarten',
    example: 'Gegnerischer Vladimir Putin −3 Einfluss',
  },

  'Oppositionsblockade': {
    name: 'Oppositionsblockade',
    category: 'Sofort-Initiative',
    gameEffect: 'Gegner kann keine Sofort-Initiativen spielen (bis zu seinem nächsten Zug).',
    deckCost: 3,
    subcategories: ['Groß'],
    cardType: 'Sofort-Initiative',
    tier: 'T3',
    usage: 'Gegen Sofort-Initiative-Strategien',
    example: 'Gegner kann keine "Partei-Offensive" mehr spielen; Dauerhaft-Initiativen bleiben erlaubt',
  },
  ...
  'Whataboutism': {
    name: 'Whataboutism',
    category: 'Sofort-Initiative',
    gameEffect: 'Reaktiviere eine eigene deaktivierte Karte; Regierungskarten erhalten dabei −2 Einfluss.',
    deckCost: 3,
    subcategories: ['Mittel'],
    cardType: 'Sofort-Initiative',
    tier: 'T2',
    usage: 'Um deaktivierte Karten wieder zu nutzen',
    example: 'Deaktivierte Regierungskarte ist wieder aktiv, aber −2 Einfluss',
  },
  ...
  'Cyber-Attacke': {
    name: 'Cyber-Attacke',
    category: 'Intervention',
    gameEffect: 'Die Plattform-Karte wird deaktiviert',
    deckCost: 3,
    subcategories: ['Standard'],
    cardType: 'Intervention',
    tier: 'T3',
    trigger: 'Gegner spielt eine Plattform-Karte',
    example: 'Gegner spielt Mark Zuckerberg → er ist deaktiviert'
  },
  ...
  'Interne Fraktionskämpfe': {
    ...
    category: 'Intervention',
    gameEffect: 'Die große Initiative wird annulliert',
    deckCost: 3,
    subcategories: ['Standard'],
    cardType: 'Intervention',
    tier: 'T2',
    trigger: 'Gegner spielt eine große Initiative (BP ≥ 3)',
  ...
  'Bestechungsskandal 2.0': {
    ...
    category: 'Sofort-Initiative',
    gameEffect: 'Wähle eine gegnerische Regierungskarte und würfle W6. Erfolg bei W6 ≥ aktuellem Einfluss (keine Oligarch-Boni). Bei Erfolg übernimmst du die Karte.',
    deckCost: 5,
    subcategories: ['Corruption'],
    cardType: 'Sofort-Initiative',
    tier: 'T3',
    trigger: 'Manuelle Zielauswahl – wähle gegnerische Regierungskarte',
    example: 'Ziel mit Einfluss 4 → brauchst W6 ≥ 4'
  },
  ...
  'Parlament geschlossen': {
    ...
    category: 'Intervention',
    gameEffect: 'Gegner kann bis zu seinem nächsten Zug keine weiteren Regierungskarten spielen.',
    deckCost: 3,
    subcategories: ['Standard'],
    cardType: 'Intervention',
    tier: 'T3',
    trigger: 'Gegner hat 2 oder mehr Regierungskarten',
    example: 'Gegner hat 2 Regierungskarten → Lock bis zu seinem nächsten Zugbeginn'
  },
  ...
  'Cancel Culture': {
    name: 'Cancel Culture',
    category: 'Intervention',
    gameEffect: 'Die Öffentlichkeitskarte wird deaktiviert, wenn sie Oligarch oder Medien/Plattform ist.',
    deckCost: 2,
    subcategories: ['Standard'],
    cardType: 'Intervention',
    tier: 'T2',
    trigger: 'Gegner spielt eine Oligarch- oder Medien-/Plattform-Öffentlichkeitskarte',
    example: 'Gegner spielt Elon Musk → er ist deaktiviert; Denker ohne Medien-Tag sind sicher'
  },
  ...
  'Scandal Spiral': {
    name: 'Scandal Spiral',
    category: 'Intervention',
    gameEffect: 'Die zweite Öffentlichkeitskarte des Gegners wird annulliert',
    deckCost: 2,
    subcategories: ['Standard'],
    cardType: 'Intervention',
    tier: 'T2',
    trigger: 'Gegner spielt eine zweite Öffentlichkeitskarte',
    example: 'Gegner legt die 2. Öffentlichkeitskarte → sie wird annulliert'
  },
};
